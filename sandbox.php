...
$payfastdata = array('receiver' => '15507288');
...
<a href='<?php 
echo $test;
?>' target='_blank'>Click here to visit Google</a><br/> 
<a href='https://www.payfast.co.za/eng/process?cmd=_paynow&amp;<?php 
echo $payfastline;
?>' target='_blank'>Click here to Pay Gerald</a><br/> 
<a href='<?php 
echo $link_to_google;
?>' target='_blank'>Click here to visit Google</a><br/> 
<a href='<?php 
echo $link_to_quora;
?>' target='_blank'>Click here to visit Quora</a> 
